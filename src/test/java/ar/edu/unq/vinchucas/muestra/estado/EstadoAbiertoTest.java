...
public class EstadoAbiertoTest {
    ...
    public void testUsuarioBasicoPuedeOpinar() {
        ...
        when(sistemaOpiniones.yaOpinoElUsuario(otroUsuario)).thenReturn(false);
    ...
    public void testCreadorNoPuedeOpinar() {
        assertFalse(estadoAbierto.puedeOpinarUsuario(usuarioBasico, muestra));
    }

    @Test
    public void testUsuarioQueYaOpinoNoPuedeOpinarDeNuevo() {
        Usuario otroUsuario = mock(Usuario.class);
        when(sistemaOpiniones.yaOpinoElUsuario(otroUsuario)).thenReturn(true);
        
        assertFalse(estadoAbierto.puedeOpinarUsuario(otroUsuario, muestra));
    }
    ...
    public void testOpinionExpertoCambiaEstadoAExperto() throws SistemaDeExcepciones {
        ...
        when(sistemaOpiniones.yaOpinoElUsuario(usuarioExperto)).thenReturn(false);
    ...
    public void testOpinionBasicaActualizaResultado() throws SistemaDeExcepciones {
        ...
        when(sistemaOpiniones.yaOpinoElUsuario(otroBasico)).thenReturn(false);
    ...
    public void testResultadoConMayoriaDeVotos() throws SistemaDeExcepciones {
        ...
        when(sistemaOpiniones.yaOpinoElUsuario(usuario1)).thenReturn(false);
        when(sistemaOpiniones.yaOpinoElUsuario(usuario2)).thenReturn(false);
